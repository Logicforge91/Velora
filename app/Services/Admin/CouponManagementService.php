...
{
    /** @param array<string, mixed> $filters @return LengthAwarePaginator<int, Coupon> */
    public function paginate(array $filters): LengthAwarePaginator
    {
        $search = trim((string) ($filters['search'] ?? '')); $state = (string) ($filters['state'] ?? '');
    ...
    public function create(array $data): Coupon { return Coupon::query()->create($data); }
    /** @param array<string, mixed> $data */
    public function update(Coupon $coupon, array $data): Coupon { $coupon->update($data); return $coupon->fresh(); }
